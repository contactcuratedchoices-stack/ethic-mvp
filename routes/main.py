...
from openai import OpenAI # 🚀 Groq hataya, OpenAI SDK lagaya (DeepSeek ke liye perfect hai)
import os
import base64
import wave
import io
...
# OpenAI client ko DeepSeek ke base URL par redirect kar diya
...
def generate_story():
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            model="deepseek-chat", # DeepSeek ka standard aur sabse best model identifier
